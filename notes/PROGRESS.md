...
| 6.x publication | DONE | HF r0b0tlab/Qwen3.8-Flash-Next-EXL3-2.50bpw VERIFIED (21 files, 61 GB, card+parent link); GitHub r0b0tlab/qwen38-flashnext-exl3 pushed; GHCR ghcr.io/r0b0tlab/qwen38-flash-next-exl3 both tags PUBLIC (anonymous pull verified). Source deleted (335 GB freed). ALL DONE. |
